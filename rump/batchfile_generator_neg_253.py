...
"""
Description : This code generates batchfile for MZmine-2.53 to process positive data
Copyright   : (c) LemasLab, 02/23/2020
Author      : Xinsong Du
License     : GNU GPL-v3.0 License
Maintainer  : xinsongdu@ufl.edu, manfiol@ufl.edu, djlemas@ufl.edu
Usage       : python batchfile_generator_neg_253.py -x $batchfile_output_location
...
"        </parameter>\n\
    ...
    <batchstep method=\"io.github.mzmine.modules.dataprocessing.id_complexsearch.ComplexSearchModule\">\n\
        ...
        <parameter name=\"Max complex peak height\">0.4</parameter>\n\
    </batchstep>\n\
